...
<div class="container">
    <div class="row p-3">
        <div class="col">
            ...
            <p class="lead d-print-none">This application uses the logic from <a href="{{ asset('Prep TT Summer 24.pdf') }}" target="_blank">Mr Barker's Prep Timetable sheet</a> to auto-populate your
                Prep Timetable.</p>
        </div>
    </div>
    <main>
